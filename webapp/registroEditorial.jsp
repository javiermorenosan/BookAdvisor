    ...
    %>
        ...
        <div id="div-login">
            <div class="templatemo-container">
              <div class="wrapper">
                    <form class="form-signin" method="post" action="/registroEditorial" style="background-color: black;opacity: 0.9;margin-bottom: pad;padding-bottom: 20px;border-radius: 5px;">     
